...
q_all = quantile([1 2; 3 5; 5 6], [0.25 0.5 0.75], "all");
q_vec = quantile([1 2; 3 5; 5 6], [0.25 0.5 0.75], [1 2]);
q_vec13 = quantile([1 2; 3 5; 5 6], [0.25 0.5 0.75], [1 3]);
...
q_empty = quantile([], 0.5);
q_empty_cols = quantile(zeros(0, 3), 0.5);
q_empty_rows_size = size(quantile(zeros(3, 0), 0.5));
q_empty_dim2_size = size(quantile(zeros(0, 3), 0.5, 2));

p_cols = prctile([1 2; 3 5; 5 6], [25 50 75]);
p_rows = prctile([1 2; 3 5; 5 6], [25 50 75], 2);
p_all = prctile([1 2; 3 5; 5 6], [25 50 75], "all");
p_vec = prctile([1 2; 3 5; 5 6], [25 50 75], [1 2]);
...
p_empty = prctile([], 50);
p_empty_cols = prctile(zeros(0, 3), 50);
p_empty_rows_size = size(prctile(zeros(3, 0), 50));
